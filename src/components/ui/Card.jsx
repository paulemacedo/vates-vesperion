...
const Card = ({
  ...
  return (
    <motion.div
      className={[
        'relative bg-gradient-to-br from-primary/5 to-primary/10 backdrop-blur-sm border border-gold/20 rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 min-h-[18rem] flex flex-col',
